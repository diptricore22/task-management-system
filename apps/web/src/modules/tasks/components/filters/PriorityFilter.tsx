...
import { TaskPriority } from '@/modules/tasks/types/filters.types';
...
/**
 * PriorityFilter component - Multi-select dropdown for task priority
 * OR logic: matches tasks with ANY selected priority
 */
